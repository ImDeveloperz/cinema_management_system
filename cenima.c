...
void remplirToutLesTableFromFile()
{
    ...
    for (i = 0; i < nb_reservation; i++) 
    {
        ...
        {
            printf("Aucun client trouver pour la reservation avec l'ID %u.\n", clientId);
        }
    }
    ...
    for (i = 0; i < nb_reservation; ++i)
    {
        ...
        {
            printf("Aucune projection trouver pour la r̩servation avec l'ID de projection %u.\n", projectionId);
        }
    }
    ...
    for (i = 0; i < nb_projections; ++i)
    {
        ...
        {
            printf("Erreur : Aucun film trouver pour la projection avec l'ID de film %u.\n", filmId);
        }
    }
            ...
            while (choixSalle != 0)
            {
                if (estSallExiste(salles, nb_salles, choixSalle) == 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            printf("\n|-------------------Ajout de Projection...\n\n");
                            creeProjection(p, choixFilm, choixSalle);
